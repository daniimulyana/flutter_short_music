...
class MusicPlayerCubit extends Cubit<MusicPlayerState> {
  ...
  void loadMusic(Music music) async {
    try {
      emit(state.copyWith(playerState: AudioPlayerState.loading, music: music));
      await audioPlayer.setAudioSource(
          AudioSource.uri(Uri.parse(music.previewUrl)),
      ...
      emit(state.copyWith(
          errorMessage: error.message, playerState: AudioPlayerState.failure));
    }
  }
